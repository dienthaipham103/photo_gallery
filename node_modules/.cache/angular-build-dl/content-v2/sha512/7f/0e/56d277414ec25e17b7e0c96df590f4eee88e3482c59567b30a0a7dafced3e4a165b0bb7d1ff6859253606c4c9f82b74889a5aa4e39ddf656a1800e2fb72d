  ...
  function node_modulesIonicPwaElementsDistEsmPwaCameraEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const CameraPWA = class {
      ...
      async componentDidLoad() {
        ...
        await this.queryDevices(); // Initialize the camera
      ...
      async initCamera(constraints) {
        ...
        try {
          const stream = await navigator.mediaDevices.getUserMedia(Object.assign({
            video: true,
            audio: false
          }, constraints));
      ...
      async initPhotoCapabilities(imageCapture) {
        ...
        if (c.fillLightMode.length > 1) {
          this.flashModes = c.fillLightMode.map(m => m); // Try to recall the current flash mode
      ...
      render() {
        const videoStreamStyle = this.facingMode == "user" ? {
          transform: 'scaleX(-1)'
        } : {};
        return Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          ...
          class: "shutter",
          onClick: e => this.handleShutterClick(e)
        }, Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "shutter-button"
        })), Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "rotate",
          onClick: e => this.handleRotateClick(e)
        }, Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("img", {
